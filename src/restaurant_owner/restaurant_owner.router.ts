...
restuarantOwnerRouter.get("/restuarantOwner/:id",userOrAdminRoleAuth, getRestuarantOwner)
...
restuarantOwnerRouter.get("/restuarantOwnerInfo",userOrAdminRoleAuth, getMoreRestaurantOwnerInfo)
