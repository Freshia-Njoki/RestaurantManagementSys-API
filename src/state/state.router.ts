...
stateRouter.get("/states",userOrAdminRoleAuth, listStates);
//get a single State    api/States/1
stateRouter.get("/states/:id",userOrAdminRoleAuth, getState)
// create a State 
...
stateRouter.get("/statesInfo",userOrAdminRoleAuth, getMoreStateInfo)
